  ...
  constructor() {
    ...
    if (config.accountKey.startsWith('sv=')) {
      ...
      this.tableClient = new TableClient(
        ...
        'comments', // Use separate table for comments
        sasCredential
      );
      console.log('Comments Table Client initialized with SAS token for:', `https://${config.accountName}.table.core.windows.net/comments`);
    } else {
